...
import com.zamozon.response.ApiResponse;
import com.zamozon.response.PaymentLinkResponse;
import com.zamozon.service.OrderService;
  ...
  public ResponseEntity<ApiResponse> redirect(@RequestParam(name="payment_id") String paymentId,@RequestParam("order_id")Long orderId) throws RazorpayException, OrderException {
	  ...
	  try {
		...
		if(payment.get("status").equals("captured")) {
			...
			// Remove all cart items for the user after successful payment
			cartItemService.removeAllCartItemsByUserId(user.getId());
